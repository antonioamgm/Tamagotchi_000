    ...
    //for(i in valor){
        switch (valor){
            ...
            //controlamos el estado de animo con besar
                ...
                }else if(this.estadoanimo<=(animomax-this.afectividad.acariciar)){
            ...
            //controlamos el estado de animo con acariciar
             case this.afectividad.acariciar: //acariciar
                if (this.estadoanimo<=(animomax-this.afectividad.acariciar)){
                 this.estadoanimo+=this.afectividad.acariciar;
                }
            break;
        }
...
function fntCargarCanvas(){
      //debugger;
     var milienzo = document.getElementById('pantalla');
     var lienzo = milienzo.getContext('2d');
     var img = new Image();
     img.src='fondo.png';
     img.onload=function(){
...
function fntActualizaEstado(){
  //debugger;
   var milienzo=document.getElementById('estado');
   var lienzo=milienzo.getContext('2d');
   lienzo.clearRect(0, 0, 600, 100);
   lienzo.fillStyle='rgba(255,255,255,1)';
   lienzo.fillRect(0,0,600,100);
   ...
   var rojoverde=5;
   // 1 Estado de animo control del cuadro
   if(tamagotchi.estadoanimo>rojoverde){
     cred=0;
     cgreen=255;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Estado de animo: ',20,20);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(120,5,tamagotchi.estadoanimo*10,20);
   // 2 Estado de sueño control del cuadro
   if(tamagotchi.sueno>5){
     cred=200;
     cgreen=0;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Ganas de dormir: ',230,20);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(330,5,tamagotchi.sueno*10,20);
   // 3 Estado ganas de comer control del cuadro
    if(tamagotchi.hambre>5){
     cred=200;
     cgreen=0;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Ganas de comer: ',20,50);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(120,35,tamagotchi.hambre*10,20);
    // 4 Control de peso
    if(tamagotchi.peso>50){
     cred=200;
     cgreen=0;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Aumento de peso: ',230,50);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(330,35,tamagotchi.peso,20);
   //Estado de salud
    if(tamagotchi.salud>5){
     cred=0;
     cgreen=200;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Estado de salud: ',20,80);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(120,65,tamagotchi.salud*10,20);
   //Control de higiene
    if(tamagotchi.higiene>5){
     cred=0;
     cgreen=200;
     cblue=0;
   }else{
   ...
   lienzo.fillText('Higiene: ',230,80);
   lienzo.fillStyle='rgba('+cred+','+cgreen+','+cblue+',1)';
   lienzo.fillRect(330,65,tamagotchi.higiene*10,20);
...
//      debugger;
        ...
        tamagotchi.fntLanzaFunciones(e.target.id);
    }
